...
if(!isset($_SESSION["sess_user"])){
	...
	if($numtask['number']<$dailyviewsforeachuser){
...
<form action="" method="POST">
   <center>
   <h1 style="color:#ccc;float: left;">Task Number: <?php echo $tasknu;?> of <?php echo $dailyviewsforeachuser;?></h1>
<div id="next"> 
<img src="captcha.php" />
...
if(NumberCheck($_POST["micronanopico"])!=0 && NumberCheck($_POST["micronanopico"])!="" && $_SESSION["code"]==NumberCheck($_POST["micronanopico"])){
